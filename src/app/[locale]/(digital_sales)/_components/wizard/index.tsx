...
export default function Wizard() {
  ...
  return (
    <main className="relative after:bottom-0 after:left-0 after:top-0 after:z-10 after:w-1/2 after:bg-gray-100 lg:after:absolute lg:after:content-[''] rtl:after:right-0">
      <section className="min-h-layout container relative z-20 grid h-full grid-cols-2">
        {(["register", "requirements", "domain"] as Wizards[]).includes(
          currentWizard,
        ) ? (
          <>
            <div className="hidden h-screen items-center justify-center lg:flex">
              <Image
                src={planningPrice}
                alt="planning price"
                width={1000}
                height={800}
                className="mx-4 w-full rounded-3xl bg-slate-100 shadow-md"
              />
            </div>
